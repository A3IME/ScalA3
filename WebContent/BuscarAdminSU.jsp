...
%>
	...
	<!-- Barra de Navegação-->
		  ...
		  <div class="container-fluid">
		   ...
		   <div class="collapse navbar-collapse" >
		   	<ul class="nav navbar-nav">
				...
				<li><a href="BuscarAdminSU.jps">Buscar</a></li>
			</ul>
		...
		<div class="row">
			...
			<div class="col-lg-4">
				<form action="/ScalA3/SuperUsuarioServlet" method="post" class="form-group form-horizontal" style="padding-top:80px" target="display">
					
					<h4 class="center text-center">Buscar Admin</h4>
					<center>
